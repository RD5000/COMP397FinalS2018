...
/// <reference path="../../Scripts/objects/enemy2.ts"/>
/// <reference path="../../Scripts/objects/bullet.ts"/>
/// <reference path="../../Scripts/objects/backdrop.ts"/>
/// <reference path="../../Scripts/objects/backdrop2.ts"/>
/// <reference path="../../Scripts/objects/backdrop3.ts"/>
/// <reference path="../../Scripts/objects/plane.ts"/>
/// <reference path="../../Scripts/objects/coin.ts"/>
/// <reference path="../../Scripts/objects/island.ts"/>
/// <reference path="../../Scripts/objects/creep.ts"/>

/// <reference path="../../Scripts/scenes/endless.ts"/>
/// <reference path="../../Scripts/scenes/tutorial.ts"/>
